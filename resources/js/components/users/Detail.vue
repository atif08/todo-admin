                ...
                <div class="my-2 w-full">
                    <div class="border-gray-200 sm:rounded-lg w-full ">
                        ...
                        <div class="mt-5 mb-5"   >
                            ...
                            <span v-else>
                                <p class="text-sm"> <span >No current location</span></p>
                            </span>

                        </div>
                        <h3 v-if="locations.length>0"><b>Previous location</b></h3>
...
<script>
    ...
    export default {
        ...
        methods: {
            getSingle() {
                this.axios.get('/api/admin/users/'+this.$route.params.id+'/current-location').then(response => {
            ...
            getAll() {
                this.axios.get('/api/admin/users/'+this.$route.params.id+'/locations').then(response => {
